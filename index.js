...
/*adquire a quantidade total de questões + seleciona o span e substitui os valores de acordo com o 
numero de corretas */
...
//loop para criar cada questão
  for(const item of questions) {
    const quizItem = template.content.cloneNode(true)
    quizItem.querySelector('h3').textContent = item.question 

//loop para criar as respostas e validá-las somando se correto e subtraindo caso errado
...
//condição para validar se está correto ou não
            if(itsCorrect) {
                corrects.add(item)
            }   else {
